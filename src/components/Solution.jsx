...
export default function Solution() {
  return (
    <section style={{ background: '#111840', color: 'white', padding: '80px 6%' }}>
      <div className="solution-grid" style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 400px', gap: 64, alignItems: 'start' }}
        className="solution-grid">

        {/* Left */}
        <div>
          <p style={{ fontSize: 12, fontWeight: 700, letterSpacing: 3, textTransform: 'uppercase', color: '#f5a623', marginBottom: 12 }}>
            Our Solution
          </p>

          <motion.h2 variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
            style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 800, marginBottom: 20, lineHeight: 1.3 }}>
          ...
          <motion.p variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
            style={{
              ...
              fontSize: 'clamp(14px, 1.8vw, 17px)', color: 'rgba(255,255,255,0.75)',
              lineHeight: 1.9, marginBottom: 36, padding: '16px 20px',
              borderLeft: '3px solid #f5a623', background: 'rgba(255,255,255,0.05)',
        ...
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          <div style={{
            background: 'white', color: '#1a1a2e', borderRadius: 20,
            padding: '38px 34px', boxShadow: '0 24px 60px rgba(0,0,0,0.4)',
            position: 'relative', overflow: 'hidden'
          }}>
            <span style={{
              display: 'inline-block', background: 'rgba(46,125,50,0.12)', color: '#2e7d32',
              border: '1px solid rgba(46,125,50,0.3)', fontSize: 11, fontWeight: 700,
              letterSpacing: 1.5, textTransform: 'uppercase', padding: '5px 14px',
            ...
            <h3 style={{
              ...
              color: '#1a2357', marginBottom: 10, lineHeight: 1.4
            }}>
            ...
            <a href="tel:7736025600" style={{
              ...
              padding: 16, borderRadius: 7, fontSize: 20, fontWeight: 800,
              textDecoration: 'none', boxShadow: '0 8px 24px rgba(192,57,43,0.35)'
            }}>
            ...
            <a href="#contact" style={{ display: 'block', textAlign: 'center', color: '#1a2357', fontWeight: 600, fontSize: 14, textDecoration: 'none' }}>
